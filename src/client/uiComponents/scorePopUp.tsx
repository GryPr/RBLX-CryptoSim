...
export class EphemeralClick extends Roact.Component<ephemeralClickProps, ephemeralClickState> {
    ...
    public render(): Roact.Element{
        return(
            <screengui Key="EphemeralClick">
                ...
                Position={this.binding.map((value) => {return this.position.Lerp(new UDim2(this.position.X,new UDim(1.2)), value)})}
                Size={new UDim2(0.1,20,0.04,20)}>
                    ...
                    Text={`${SciNumToolKit.removeDecimal(this.props.addend.Base, 1)}${getOrderPrefix(this.props.addend.Exponent)}`}/>
